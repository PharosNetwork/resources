...
ALDABA = 'aldaba'
ALDABA_LIGHT = 'aldaba_light'
ALDABA_VERSION = 'VERSION'
EVMONE_SO = 'libevmone.so'
DORA_SO = 'libdora_c.so'

ALDABA_BIN = 'aldaba'
ALDABA_BIN_LIGHT = 'aldaba_light'
ALDABA_GENESIS_CONF = 'genesis.conf'
ALDABA_LAUNCH_CONF = 'launch.conf'
...
CLI_BINARYS = [ALDABA_CLI, ETCD_CTL_BIN, EVMONE_SO, SVC_META_TOOL, DORA_SO]

BINARY_MAP = {
    SERVICE_ETCD: ETCD_BIN,
    SERVICE_STORAGE: STORAGE_BIN,
    SERVICE_PORTAL: ALDABA_BIN,
    SERVICE_DOG: ALDABA_BIN,
    SERVICE_TXPOOL: ALDABA_BIN,
    SERVICE_CONTROLLER: ALDABA_BIN,
    SERVICE_COMPUTE: ALDABA_BIN,
    SERVICE_LIGHT: ALDABA_BIN_LIGHT,
}
