...
from aldaba_ops.toolkit import conf, core, logs
import traceback
...
def add_validator(endpoint, key, domains):
    """
    Command: aldaba-ops add-validator
    """
...
def exit_validator(endpoint, key, domains):
    """
    Command: aldaba-ops exit-validator
    """
