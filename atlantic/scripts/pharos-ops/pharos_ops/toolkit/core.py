...
class Composer(object):
    ...
    def deploy_local_cli(self):
        ...
        # Copy genesis file only if it exists (generated by generate-genesis command)
        if exists(self._domain.genesis_conf):
        ...
        # copy genesis_conf and rename to genesis.conf (only if exists)
        if exists(self._domain.genesis_conf):
